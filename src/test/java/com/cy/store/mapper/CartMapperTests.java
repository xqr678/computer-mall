...
public class CartMapperTests {
    ...
    public void findVOByUid() {
        List<CartVO> list = cartMapper.findVOByUid(17);
    ...
    @Test
    public void deleteByUidAndCid(){
        Integer[] cids = {1,2,3};
        cartMapper.deleteByUidAndCid(cids);
    }

    @Test
    public void findByOids(){
        Integer[] oids={5};
        List<OrderItem> oidList = cartMapper.findByOids(oids);
